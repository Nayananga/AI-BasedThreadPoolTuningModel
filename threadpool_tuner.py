...
from general_utilities.bayesian_opt import calculate_maximum_bayesian_expected_improvement, select_next_x_point
...
def find_next_threadpool_size(threadpool_and_throughput_data, latency_data, trade_off_level, model, throughput):
    ...
    if min_latency is None:
        ...
        next_threadpool_size, trade_off_level = select_next_x_point(
...
def update_model(next_threadpool_size, threadpool_and_throughput_data, latency_data, trade_off_level):
    threadpool_and_throughput_data, latency_data, trade_off_level = sample_by_fifo(next_threadpool_size,
