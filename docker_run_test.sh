...
docker run --publish 5000:5000 --name tuner -d --net myNet --ip 192.168.1.3 --volume /home/nayananga/output/Prime1m_1:/app/Data/ACTUAL --cpus=1 nayanagamuhandiram/python_service:hpc_testing_4  python app.py no_train
...
docker run --publish 6379:6379 --name some-redis -d --net myNet --ip 192.168.1.2 --cpus=1 redis
docker run --publish 5000:5000 --name tuner -d --net myNet --ip 192.168.1.3 --volume /home/nayananga/output/Prime1m_10:/app/Data/ACTUAL --cpus=1 nayanagamuhandiram/python_service:hpc_testing_4  python app.py no_train
...
docker run --publish 6379:6379 --name some-redis -d --net myNet --ip 192.168.1.2 --cpus=1 redis
docker run --publish 5000:5000 --name tuner -d --net myNet --ip 192.168.1.3 --volume /home/nayananga/output/Prime1m_50:/app/Data/ACTUAL --cpus=1 nayanagamuhandiram/python_service:hpc_testing_4  python app.py no_train
